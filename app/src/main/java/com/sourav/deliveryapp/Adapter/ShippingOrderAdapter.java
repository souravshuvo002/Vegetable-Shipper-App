...
public class ShippingOrderAdapter extends RecyclerView.Adapter<ShippingOrderAdapter.ViewHolder> {
    ...
    public ShippingOrderAdapter(List<Foods> foodList, Fragment context) {
    ...
    public ShippingOrderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_all_shipping_order_history_items, parent, false);
        return new ShippingOrderAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final ShippingOrderAdapter.ViewHolder holder, final int position) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        *//*if(item.equalsIgnoreCase("Accept"))
                        ...
                        else *//*if(item.equalsIgnoreCase("Complete"))
                        {
                            ...
                            showPaymentDialog(food.getTotal_price());
                            //sendEmail("shuesh002@gmail.com", food.getId_order());
                            //sendEmail(food);
                        }
                        ...
                        Call<Result> call = service.updateOrderStatus(food.getId_order(), USER_ID, finalStatus_ID[0], payment_state[0]);
                        ...
                        call.enqueue(new Callback<Result>() {
                            ...
                            public void onResponse(Call<Result> call, Response<Result> response) {
                                ...
                                ((ShippingFragment) context).loadShippingOrder();
                            }
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.fragment_state = "SHIPPING";
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView textViewName, textViewOrderID, textViewOrderDate, textViewAddress, textViewItemPrice, textViewOrderStatus,
                textViewArea, textViewPayment, textViewDelDate;
    ...
    private void sendOrderUpdateNotification(final String id_order, final String id_user, final String status) {
        ...
        call.enqueue(new Callback<Result>() {
            ...
            public void onResponse(Call<Result> call, Response<Result> response) {
                ...
                datasend.put("title", "SabjiWala App");
    ...
    private void showPaymentDialog(String amount) {
        ...
        textViewAmount.setText(new StringBuilder(context.getResources().getString(R.string.currency_sign)).append(df2.format(price)));
    ...
    /*private void sendEmail(String userEmail, String orderNo) {

        String[] TO = {userEmail};
        String[] CC = {"shuvo1060@gmail.com"};
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT,   "Sabjiwala - " + orderNo);
        ...
        try {
            ...
            Toast.makeText(context.getActivity(), "There is no email client installed.", Toast.LENGTH_SHORT).show();
        }
    }*/
}