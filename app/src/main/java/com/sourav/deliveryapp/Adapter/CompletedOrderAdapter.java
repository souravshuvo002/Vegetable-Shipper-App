...
public class CompletedOrderAdapter extends RecyclerView.Adapter<CompletedOrderAdapter.ViewHolder> {
    ...
    public CompletedOrderAdapter(List<Foods> foodList, Fragment context) {
    ...
    @Override
    public void onBindViewHolder(final CompletedOrderAdapter.ViewHolder holder, final int position) {
        ...
        if(food.getTransfer_state().equalsIgnoreCase("1"))
        {
            holder.textViewTransferStatus.setText("Transferred");
        }
        else
        {
            holder.textViewTransferStatus.setText("Not transferred");
        }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        call.enqueue(new Callback<Result>() {
                            ...
                            public void onResponse(Call<Result> call, Response<Result> response) {
                                ...
                                ((CompletedFragment) context).loadCompletedOrder();
                            }
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView textViewName, textViewOrderID, textViewOrderDate, textViewAddress, textViewItemPrice, textViewOrderStatus,
                textViewArea, textViewTransferStatus, textViewPayment, textViewDelDate;
